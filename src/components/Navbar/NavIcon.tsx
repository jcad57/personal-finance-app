...
export default function NavIcon({ icon, label, text, isActive }: NavigationTabProps) {
    return (
        <li
            className={
                `w-full py-[var(--spacing-xs)] rounded-t-lg border-b-4 lg:rounded-t-none lg:rounded-r-lg  lg:py-[var(--spacing-sm)] lg:border-b-0` +
                (isActive
            ...
            <Link href={`/${label}`} className="w-full md:flex md:flex-col md:gap-2 lg:flex-row md:items-center ">
                <Image
                    className={
