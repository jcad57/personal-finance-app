            ...
            <Fieldset className="w-full grid gap-[var(--spacing-s)] mb-[var(--spacing-md)]">
                <Field className="relative flex flex-col gap-[4px]">
                    ...
                    <Input
                        ...
                        value={potName}
                        className="appearance-none px-[var(--spacing-md)] py-[var(--spacing-xs)] rounded-[var(--spacing-xxs)] border-1 border-[var(--beige-500)] bg-[var(--white)] text-left text-[var(--grey-900)] focus:border-[var(--grey-900)] focus:outline-none invalid:border-[var(--red)]"
