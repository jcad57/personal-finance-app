"use client";
import { sortOptions } from "@/lib/sorting-options";
import { RecurringBillsProps } from "@/lib/types";
import { useSearchParams } from "next/navigation";
import { applySortAndFilter } from "@/lib/helpers";
      ...
      <PrimaryCard>
        ...
        <section id="All Recurring Bills List" className="md:hidden">
          {sorted.length > 0 ? (
            ...
            <div className="text-center text-[var(--grey-500)] py-[20px]">
