...
import { RecurringBillsProps } from "@/lib/types";
    ...
    <table className="w-full">
      <thead className="">
        <tr className="w-full text-left text-[var(--grey-500)] text-[length:var(--font-size-xs)] border-b-[1px] border-[var(--grey-500)]/15">
          <th className="w-[60%] pb-[var(--spacing-xs)] font-normal">
            Bill Title
          </th>
          <th className="w-[20%] pb-[var(--spacing-xs)] font-normal">
            Due Date
          </th>
          <th className="w-[20%] pb-[var(--spacing-xs)] font-normal text-right">
            Amount
          </th>
        </tr>
      </thead>
      <tbody>
        {recurringBills.map((bill, index) => {
          ...
          return (
            <tr
              key={bill.id}
              className="not-first:border-t-[1px] not-first:border-[var(--grey-500)]/15 "
            >
              <td
                style={{
